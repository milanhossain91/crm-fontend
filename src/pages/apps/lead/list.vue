...
const headers = [
  ...
  {
    title: "Lead Name Assigned To",
    key: "name",
  },
  {
    title: "Prospect & Concern person",
    key: "prospect_id",
  },
  {
    title: "Item",
  ...
  {
    title: "Amount & Closing",
    key: "closing_amount",
  },
  {
    title: "Win (%) Probablity",
    key: "winprobability_id",
  },
  {
    title: "Priority",
    key: "priority_id",
...
const deleteService = async id =>{
  try {
    const res = await $api(`${baseUrl}/lead/${id}`, {
      method: "DELETE",
    })
      ...
      <VCardText class="d-flex flex-wrap py-4 gap-4">
        ...
        <div class="app-user-search-filter d-flex align-center flex-wrap gap-4">
          ...
          <VBtn
            ...
            @click="() => router.push({name:'apps-lead'})"
          >
            Add New Lead
          </VBtn>
        </div>

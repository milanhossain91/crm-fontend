...
const headers = [
  ...
  {
    title: "Order Sub. & Person",
    key: "sale_order_subject",
  },
  {
    title: "Lead Name",
    key: "lead_id",
...
const deleteService = async id =>{
  try {
    const res = await $api(`${baseUrl}/sales-order/${id}`, {
      method: "DELETE",
    })
      ...
      <VCardText class="d-flex flex-wrap py-4 gap-4">
        ...
        <div class="app-user-search-filter d-flex align-center flex-wrap gap-4">
          ...
          <VBtn
            ...
            @click="() => router.push({name:'apps-order'})"
          >
            Add New Order
          </VBtn>
        </div>
